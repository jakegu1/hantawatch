      ...
      <div className="prose prose-sm text-gray-700 leading-relaxed space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>要求删除你的邮箱与反馈记录：发送邮件至{' '}
              <a href="mailto:privacy@hantawatch.cn" className="text-brand-500 underline">privacy@hantawatch.cn</a>
              ，注明你希望删除的邮箱地址</li>
        ...
        <section>
          ...
          <p>
            ...
            或邮件{' '}
            <a href="mailto:privacy@hantawatch.cn" className="text-brand-500 underline">
              privacy@hantawatch.cn
            </a>{' '}
            与我们联系。
          </p>
        </section>
