...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/events/mv-hondius-2026`, lastModified: now, changeFrequency: 'daily', priority: 0.85 },
    { url: `${BASE}/destinations`, lastModified: now, changeFrequency: 'daily', priority: 0.85 },
